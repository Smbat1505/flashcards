...
import { item } from '@/components/ui/dropDown/animations'
import { Item } from '@radix-ui/react-dropdown-menu'
import clsx from 'clsx'
import { motion } from 'framer-motion'

import s from '@/components/ui/dropDown/Toolbar.module.scss'
...
interface ToolbarItemProps extends ComponentPropsWithoutRef<typeof Item> {
  children?: ReactNode
  className?: string
  disabled?: boolean
